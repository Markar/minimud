...
PROTOTYPES = {
    ...
    (2, 1): {
        ...
        "desc": "|GOn the square of the chessboard, a gnoll pup stands nervously. Its small, hyena-like frame is covered in patchy fur, and it wears a torn blue shirt with greenish yellow pants. The gnoll pup's eyes dart around, filled with a mix of curiosity and fear, as it clutches a small, rusty dagger.",
    },
    (2, 2): {
        "typeclass": "typeclasses.rooms.ChessboardGnollPup",
        "tags": [("chessboard", "zone")],
